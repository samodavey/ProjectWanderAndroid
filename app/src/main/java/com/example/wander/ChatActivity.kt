...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Hooking up adapter to chat activity
        ...
        //This retrieves the other user to display on top of the screen
    ...
    //Actually sends the message to the other user
    //This places our message inside the chat database inside our chat inside the messages node and the relevant message key
    fun onSend(v: View){
